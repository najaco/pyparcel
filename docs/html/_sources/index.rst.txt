...
pyparcel allows you to securely and easily convert your python object to and from a byte string format. When pyparcel_ performs ``pack`` on an object, it uses
